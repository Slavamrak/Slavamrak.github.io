...
function startwatch() {
	...
	watch([`app/**/*.{${fileswatch}}`, '_includes/*.html', '_layouts/*.html'], { usePolling: true }).on('change', browserSync.reload)
	gmWatch && watch(['img/_src/**/*'], { usePolling: true }, img) // GraphicsMagick watching image sources if allowed
}
